...
$pages = ['Usuarios', 'Contratistas', 'Clientes', 'Contratos', 'Tipo de Contratos', 'Facturas', 'Parqueaderos', 'Reservas', 'Roles'];
$pagesAdmin = ['Usuarios', 'Tipo de Contratos', 'Roles'];
...
try {
    ...
    if ($roles == false && $title == "Usuarios") {
        echo "<h1>Error al obtener los datos de los roles</h1>";
    } else {
        echo "<h1>Error al obtener los datos</h1>";
    }
    $response = false;
    $roles = false;
}
...
function showEditModal(id) {
    ...
    for (var i = 0; i < headers.length - 1; i++) {
        ...
        if (columnName !== "id_rol" && columnName !== "estado") {
